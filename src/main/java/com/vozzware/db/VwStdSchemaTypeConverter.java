...
public class VwStdSchemaTypeConverter implements VwSchemaTypeConverter
{
  ...
  private void buildTypeMap()
  {
    ...
    s_mapSqlTypes.put( "INTEGER",  Types.NUMERIC );
    s_mapSqlTypes.put( "CHAR", Types.CHAR );
    s_mapSqlTypes.put( "VARCHAR", Types.VARCHAR );
    s_mapSqlTypes.put( "DOUBLE", Types.DOUBLE );
    s_mapSqlTypes.put( "SMALLINT", Types.TINYINT );
    s_mapSqlTypes.put( "BIGINT", Types.BIGINT );
    s_mapSqlTypes.put( "BLOB", Types.LONGVARBINARY );
    s_mapSqlTypes.put( "TIMESTAMP", Types.TIMESTAMP );
