...
public class VwSqlMappingSpec extends VwDVOBase implements Serializable, Cloneable
{
  ...
  private List<VwColPropertyGlob>  m_listJsonPropertyGlob;         
  ...
  /**
   * Sets the jsonPropertyGlob property
   */
  public void setJsonPropertyGlob( List<VwColPropertyGlob> listJsonPropertyGlob )
  { 
    testDirty( "jsonPropertyGlob", listJsonPropertyGlob );
    m_listJsonPropertyGlob = listJsonPropertyGlob;
  }

  /**
   * Gets jsonPropertyGlob property
   * 
   * @return  The jsonPropertyGlob property
   */
  public List<VwColPropertyGlob> getJsonPropertyGlob()
  { return m_listJsonPropertyGlob; }
  ...
  public Object clone()
  {
    ...
    if ( m_listJsonPropertyGlob  != null )
      classClone.m_listJsonPropertyGlob = (List<VwColPropertyGlob>)cloneList( m_listJsonPropertyGlob );
  ...
  public boolean equals( Object objTest )
  {
    ...
    if ( ! doListElementTest( m_listJsonPropertyGlob, objToTest.m_listJsonPropertyGlob ) )
      return false;
