...
public class VwTableSpec extends VwDbObjCommon implements Serializable, Cloneable
{
  ...
  private List<VwColAlias>       m_listJsonAlias;                
  ...
  /**
   * Sets the jsonAlias property
   */
  public void setJsonAlias( List<VwColAlias> listJsonAlias )
  { 
    testDirty( "jsonAlias", listJsonAlias );
    m_listJsonAlias = listJsonAlias;
  }

  /**
   * Gets jsonAlias property
   * 
   * @return  The jsonAlias property
   */
  public List<VwColAlias> getJsonAlias()
  { return m_listJsonAlias; }
  ...
  public Object clone()
  {
    ...
    if ( m_listJsonAlias  != null )
      classClone.m_listJsonAlias = (List<VwColAlias>)cloneList( m_listJsonAlias );
  ...
  public boolean equals( Object objTest )
  {
    ...
    if ( ! doListElementTest( m_listJsonAlias, objToTest.m_listJsonAlias ) )
      return false;
