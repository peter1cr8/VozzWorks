...
public class VwOraSchemaTypeConverter implements VwSchemaTypeConverter
{
  ...
  private void buildTypeMap()
  {
    ...
    s_mapSqlTypes.put( "number", Types.NUMERIC );
    s_mapSqlTypes.put( "char",  Types.CHAR );
    s_mapSqlTypes.put( "varchar2", Types.VARCHAR );
    s_mapSqlTypes.put( "decimal", Types.DECIMAL );
    s_mapSqlTypes.put( "date", Types.DATE );
