...
public class VwBeanToXml implements XmlSerializer
{
  ...
  private Attributes getObjAttrs( Object objBean,  String strElementName )  throws Exception
  {
    ...
    try
    {
      mthdNS = objBean.getClass().getMethod( "getNamespaces" );
    }
    catch( Exception ex )
    {
      // don't care
    ...
    try
    {
      mthdUserAttrs = objBean.getClass().getMethod( "getUserAttributes" );

      List listUserAttrs = (List)mthdUserAttrs.invoke( objBean );
    ...
    if ( m_fUseAttributeModel )
    {
      ...
      if ( mthdNS != null )
        listNamespaces = (List)mthdNS.invoke( objBean );
      ...
      for ( Iterator iAttrNames = listAttrNames.iterator(); iAttrNames.hasNext(); )
      {
        ...
        if ( mthdAttr!= null )
        {
          ...
          Object objVal = mthdAttr.invoke( objBean );
    ...
    throws Exception
  {
    ...
    m_mapChildren.put( strClassName.toLowerCase(), false );
    ...
    if ( !fSkipClassName )
    {
      ...
      try
      {
        mthdIsParent = objBean.getClass().getMethod( "isParent" );
      }
      catch( Exception ex )
      {
      ...
      {
        fIsParent = ((Boolean)mthdIsParent.invoke( objBean )).booleanValue();
      }
      ...
      if ( m != null )
      {
        m_xmlWriter.addChild( strClassName, (String)m.invoke( objBean ), listAtt, true );
      }
      else
    ...
    for ( int x = 0; x < aProps.length; x++ )
    {
      ...
      Object objVal = m.invoke( objBean );
      ...
      m_mapChildren.put( strClassName.toLowerCase(),  true );
  ...
  private QName getQName( Object objBean )
  {
    ...
    try
    {
      mthdQName = objBean.getClass().getMethod( "getQName" );
      if ( mthdQName != null )
      {
        QName qnClassName = ((QName)mthdQName.invoke( objBean ));
        return qnClassName;
