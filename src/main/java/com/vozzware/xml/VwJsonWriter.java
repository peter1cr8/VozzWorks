...
public class VwJsonWriter
{
  ...
  /**
   * Adds a json string to the current writer
   * @param strJson
   */
  public void addJson( String strJson )
  {
    m_sbJson.append( strJson );
   ...
   * @param bNeedValueQuotes  if true, surround the property value in quotes
   */
  public void addProperty( String strPropName, String strPropValue, boolean bNeedValueQuotes )
  {
    addProperty( strPropName, strPropValue, bNeedValueQuotes, false );
  }
   ...
   * @param strPropValue The property value
   * @param bNeedValueQuotes  if true, surround the property value in quotes
   * @param bIgnoreQuoteEscapeCheck if true ignore escaping double quote charaters
   */
  public void addProperty( String strPropName, String strPropValue, boolean bNeedValueQuotes, boolean bIgnoreQuoteEscapeCheck )
  {
    ...
    if ( strPropValue != null )
    {
      ...
      if ( bIgnoreQuoteEscapeCheck )
      {
        m_sbJson.append( strPropValue );
      }
      else
      {
