...
public class VwDataObject implements VwServiceable
{
   ...
   *
   * @param strID The id of the object used for lookup
   * @param abData - The byte array to be added
   *
   * @exception throws VwDupValueException if the key already exists in the data object
   *  and the allowDups option is not on
   */
  ...
  {
    VwElement element = new VwElement( strID, Byte.valueOf( bVal ) );
    add( element );
  ...
  {
    VwElement element = new VwElement( strID,  Character.valueOf( cVal ) );
    add( element );
  ...
  {
    VwElement element = new VwElement( strID, Short.valueOf( sVal ) );
    add( element );
  ...
  {
    VwElement element = new VwElement( strID, Integer.valueOf( nVal ) );
    add( element );
  ...
  {
    VwElement element = new VwElement( strID, Long.valueOf( lVal ) );
    add( element );
  ...
  {
    VwElement element = new VwElement( strID, Double.valueOf( dblVal ) );
    add( element );
   ...
   *
   * @param strID The associated key in the data object
   ...
   *
   * @param strID The associated key in the data object
   * @param ins - inout stream of  to read
   *
   * @exception VwDupValueException if the key already exists in the data object
   *  and the allowDups option is not on, Exception if any io errors occur reading the file
   */
   ...
   *
   * @param strID The id of the object used for lookup
   * @param dataObj The VwDataObjList object to be added
   *
   * @exception throws VwDupValueException if the key already exists in the data object
   *  and the allowDups option is not on
   */
   ...
   *
   * @param strID The associated key in the data object
   * @param ins - input stream to read
   *
   ...
   */
  public void put( String strID, boolean bVal )
  {
    VwElement element = new VwElement( strID, bVal );
    put( element );
   ...
   *
   * @param chVal The char value to store
   */
  public void put( String strID, char chVal )
  {
    VwElement element = new VwElement( strID, chVal );
    put( element );
  ...
  {
    VwElement element = new VwElement( strID, sVal );
    put( element );
  ...
  {
    VwElement element = new VwElement( strID, nVal );
    put( element );
  ...
  {
    VwElement element = new VwElement( strID, lVal );
    put( element );
  ...
  {
    VwElement element = new VwElement( strID, dblVal );
    put( element );
   ...
   *
   * @param strID - The character ID of the data element to put in the content map
   * @param elementList - The data object to store
   *
   */
   ...
   *
   * @param strID - The character ID of the data element to put in the content map
   * @param dataObjList - The data object to store
   *
   */
   ...
   *
   * @param strID - The numeric ID of the data element to retrieve
   *
