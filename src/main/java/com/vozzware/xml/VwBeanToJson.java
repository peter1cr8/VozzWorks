...
public class VwBeanToJson
{
    ...
    throws Exception
  {
    ...
    for ( int x = 0; x < aProps.length; x++ )
    {
      ...
      // see if there is a Json annotation property override
      if ( m.isAnnotationPresent( VwJsonProperty.class ) )
      {
        m_strCurPropName = strPropName =  m.getAnnotation( VwJsonProperty.class ).prop() ;
      }
                                     ...
                                     String strClassName )  throws Exception
  {
    ...
    {
      handleMap( strPropName,  (Map)objVal );
      return;
    }
  ...
  private void handleMap( String strPropName, Map map ) throws Exception
  {
    String strMapJson = VwJsonUtils.toJson( map );
    m_jsonWriter.addProperty( strPropName, strMapJson, false, true );
