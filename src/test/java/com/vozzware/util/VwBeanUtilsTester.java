...
public class VwBeanUtilsTester
{
  ...
  {
    /*
    TestNoArgs tna = (TestNoArgs)VwBeanUtils.createObjectInstance( "com.vozzware.util.TestNoArgs", null, null );

    assertNotNull("Expected instance of the object com.vozzware.util.TestNoArgs but got null", tna );
    ...
    TestArgs tArgs = (TestArgs)VwBeanUtils.createObjectInstance( "com.vozzware.util.TestArgs", new Class[]{String.class, int.class},
                                                                                                                    new Object[]{"Big Daddy", 45 } );
    assertNotNull("Expected instance of the object com.vozzware.util.TestArgs but got null", tArgs );
